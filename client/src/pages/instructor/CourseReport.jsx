        ...
        <>
          <Card className="p-4 bg-blue-50 border border-blue-200">
            ...
            <div class="p-2">
              <div class="flex justify-between mb-1">
                <span class="text-base font-medium dark:text-white">
                  ...
                  {enrollments.filter(e => e.EnrollmentStatus == 'Enrolled').length}
                </span>
            ...
            <div class="p-2">
              <div class="flex justify-between mb-1">
                <span class="text-base font-medium dark:text-white">
                  Tổng số học viên đã hoàn tất khóa học:{' '}
            ...
            <div class="p-2">
              <div class="flex justify-between mb-1">
                <span class="text-base font-medium dark:text-white">
                  Tổng số học viên hủy khóa học:{' '}
                  {enrollments.filter(e => e.EnrollmentStatus == 'Dropped').length}
                </span>
                <span class="text-base font-medium text-blue-700 dark:text-white">
                  {(
                    (enrollments.filter(e => e.EnrollmentStatus == 'Dropped').length /
          ...
          <Reviews data={enrollments.filter(e => e.Review != null)}></Reviews>
        </>
      )}
    </div>
  );
