...
const AddLessons = () => {
  ...
  const cloudinaryPreset = "ulvd134";
  ...
  const {
    ...
    `https://api.cloudinary.com/v1_1/${cloud_token}/video/upload`,
    `${cloudinaryPreset}`
  );
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {formData.type === "document" ? (
                ...
                <div className="">
                  <div className="flex justify-between border-gray-300 border-[1px] rounded-md">
                    <input
                      className="cursor-pointer p-2 bg-inherit rounded-lg text-black"
                    ...
                    <button
                      ...
                      disabled={!videoFile || uploading} // Vô hiệu hóa khi đang upload hoặc chưa có file
                      className="ml-3 bg-blue-600 p-2 text-white  rounded-s-none rounded-e-md hover:bg-blue-700 cursor-pointer"
                    >
                    ...
                    >
                      {(provided, snapshot) => (
                        <div
                          ...
                          className={`flex items-start space-x-3 p-4 border border-gray-200 rounded-lg lesson-item ${
                            snapshot.isDragging
