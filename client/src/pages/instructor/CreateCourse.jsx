...
const CreateCourse = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 font-sans">
      ...
      <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center">Tạo khóa học mới</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-700 mb-3">Ảnh thumbnail khóa học</h3>
                ...
                {thumbnailUrl && (
                  <div className="mt-4 max-w-xs mx-auto">
                    ...
                    <img
                      ...
                      onError={e =>
                        (e.target.src = 'https://via.placeholder.com/1280x720?text=Invalid+URL')
                      }
                    />
                  </div>
                )}
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
            ...
            <p className="text-sm text-blue-700">
              Sau khi tạo khóa học cơ bản, bạn sẽ được chuyển đến trang thêm bài học, nơi bạn có thể
              thêm các phần học và bài giảng cho khóa học của mình.
            </p>
          </div>
        </div>
      </div>
