    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <Card className="mb-6">
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs value={tabValue} onChange={handleChangeTab} aria-label="course management tabs">
            <Tab label="Tất cả" />
        ...
        <Box className="p-4">
          ...
          {loading ? (
            ...
            <Box className="text-center py-10">
              ...
              <Button variant="contained" onClick={() => window.location.reload()} className="mt-4">
                Thử lại
              </Button>
            </Box>
          ) : (
      ...
      <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            Bạn có chắc chắn muốn xóa khóa học "{selectedCourse?.Title}"? Hành động này không thể
            hoàn tác.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
