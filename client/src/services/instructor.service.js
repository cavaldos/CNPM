...
const InstructorService = {
    ...
    createLessonDocument: async (title, duration, complexityLevel, lessonType, ordinal, documentContent, courseID) => {
        const response = await axiosinstance.post("/instructor/lesson/document/create", { title, duration, complexityLevel, lessonType, ordinal, documentContent, courseID });
        return response;
    },
