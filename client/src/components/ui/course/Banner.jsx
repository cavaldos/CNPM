...
const Banner = () => {
  const url =
    'https://media.istockphoto.com/id/1500285927/vi/anh/c%C3%B4-g%C3%A1i-tr%E1%BA%BB-m%E1%BB%99t-sinh-vi%C3%AAn-%C4%91%E1%BA%A1i-h%E1%BB%8Dc-h%E1%BB%8Dc-tr%E1%BB%B1c-tuy%E1%BA%BFn.jpg?s=2048x2048&w=is&k=20&c=RudMbVZ_Uq1jz86Pzp_P8MUhjPxb8zOVepSRXl7YEqA=';
  return (
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between relative z-10">
        ...
        <div className="md:max-w-xl mb-10 md:mb-0">
          ...
          <p className="text-lg text-gray-700 mb-8 leading-relaxed">
            Start, switch, or advance your career with more than 10,000 courses, Professional
        ...
        <div className="w-full md:w-1/2 lg:w-5/12 flex justify-center items-center">
          <div className="relative w-80 h-80 rounded-full overflow-hidden shadow-2xl transform hover:scale-105 transition duration-500">
            <img src={url} alt="Online learning" className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-4">
              <span className="inline-block bg-blue-600 text-white px-3 py-1 text-sm font-semibold rounded-full mb-2 self-start">
                Featured
              </span>
