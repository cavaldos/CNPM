    ...
    <>
      ...
      <div className="max-w-6xl mx-auto py-6 px-4 bg-gray-50 min-h-screen relative">
        <div className="block items-center mb-6 max-w-4xl">
          ...
          />
          <div>
            <h1 className="text-5xl font-semibold text-gray-900 font-inter">{courseInfo.Title}</h1>
            <p className="fontsize-base text-gray-800 mt-2">{courseInfo.Description}</p>
        ...
        {isEnrolled ? (
          ...
          <div className="flex space-x-4 mb-6">
            <button
              className={`normal-case w-60 font-semibold rounded-md py-2 px-4 ${
                user.Role === 'Student'
        ...
        >
          <div className="flex-[1.5] px-10 border-gray-100 border-r-2">
            ...
            <p className="text-sm text-gray-500">{completeCurriculumText}</p>
          </div>
          <div className="flex-[0.7] px-10 border-gray-100 border-r-2">
            ...
            <p className="text-sm text-gray-500">
              ({courseInfo.ReviewCount} {reviewsText})
            </p>
          </div>
          ...
          {lessonsList.length > 0 ? (
            <div>
              <p className="text-gray-600 mb-4">
                {lessonsList.length} {lessonsText} •{' '}
                {lessonsList.reduce((acc, lesson) => acc + (lesson.Duration || 0), 0)}{' '}
                {minutesTotalLengthText}
              </p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center text-sm text-gray-500 mt-1">
                          ...
                          <span>
                            {lesson.Duration} {minutesText}
                          </span>
                          <span className="mx-2">•</span>
                          <span>
                            {complexityText}: {lesson.ComplexityLevel}
                          </span>
                        </div>
                      </div>
                      <div className="flex-shrink-0">
                        <span className="text-sm text-gray-500">
                          {lessonText} {lesson.Ordinal}
                        </span>
                      </div>
                    </div>
                  </li>
        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-4">
            <div className="flex items-center">
              ...
              <span className="text-gray-600 ml-1">{addLinkedinText}</span>
            </div>
            <div className="flex items-center">
        ...
        {courseInfo && <RelatedCourses currentCourseId={courseInfo.CourseID} />}
      </div>
    </>
  );
};
