            ...
            <div className="flex-1 overflow-y-auto bg-gray-50">
                {loading ? (
                    ...
                    <div className="flex flex-col justify-center items-center h-64 p-4">
                        ...
                        <p className="text-gray-500 text-center">No comments yet. Be the first to comment!</p> {/* Changed text */}
                    </div>
                ) : (
        ...
        <div className="rounded-full bg-gray-100 overflow-hidden flex items-center">
            ...
            <div className="flex items-center">
                ...
                <button
                    ...
                    className={`p-2 rounded-full mx-2 flex items-center justify-center ${message.trim() ? 'text-blue-600 hover:text-blue-700' : 'text-gray-400 cursor-not-allowed'
                        }`}
