    ...
    <div className="bg-gray-50 min-h-screen w-full">
      <div className="max-w-6xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{lessonData.LessonTitle}</h1>
        </div>
          ...
          {lessonData.Content ? (
            ...
            <div className="flex items-center justify-center min-h-[300px] border-2 border-dashed border-gray-200 rounded-lg">
              <div className="text-center p-6">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-1">Document Content</h3>
                <p className="text-sm text-gray-500">
                  This is where the document content would be displayed. You can add your document
                  content here.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <div className="flex space-x-6 mb-4 sm:mb-0">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium">{formatDate(lessonData.UpdatedTime)}</p>
                </div>
              </div>
            </div>
            <div className="flex space-x-3">
              ...
              <button
                ...
                className={`flex items-center px-4 py-2 rounded-md font-medium shadow-sm text-white ${
                  completeLoading
